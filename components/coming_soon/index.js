    ...
    return (
        <div className={css.coming_soon_div}>
            <div className={css.coming_soon_text_div}>   
                ...
                <p className={css.coming_soon_p}><span style={{color:'#FBB751',margin:'0',padding:'0'}}> Tələbə360+ </span>Abunəliyinə qoşularaq siz Tələbə360 xüsusi endirimlərindən faydalana biləcəksiniz</p>
            </div>
